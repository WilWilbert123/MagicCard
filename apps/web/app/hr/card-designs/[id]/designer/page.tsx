        ...
        <aside className={`w-60 border-r p-4 overflow-y-auto space-y-4 shrink-0 ${panelBorder} ${panel}`}>
          ...
          <div className="space-y-1.5">
            {[
              ...
              { label: 'Employee Full Name', icon: <User className="w-4 h-4 text-emerald-400" />, action: () => addElement('TEXT', { text: '{{employee.fullName}}', fontSize: 26, fontWeight: 'bold' }) },
              { label: 'Call Name / Nickname', icon: <User className="w-4 h-4 text-lime-400" />, action: () => addElement('TEXT', { text: '{{employee.callName}}', fontSize: 32, fontWeight: 'bold', color: '#dc2626' }) },
              ...
              { label: 'Emergency Contact', icon: <Type className="w-4 h-4 text-amber-500" />, action: () => addElement('TEXT', { text: 'ICE: {{employee.emergencyContactName}} ({{employee.emergencyContactPhone}})', fontSize: 12, color: '#475569' }) },
              ...
              { label: 'Employee Signature', icon: <PenTool className="w-4 h-4 text-emerald-500" />, action: () => addElement('IMAGE', { src: '{{employee.signatureUrl}}', width: 220, height: 60, objectFit: 'contain' }) },
              { label: 'HR Manager Signature', icon: <PenTool className="w-4 h-4 text-blue-500" />, action: () => addElement('IMAGE', { src: '{{employee.hrSignatureUrl}}', width: 220, height: 60, objectFit: 'contain' }) },
